...
export default function SocialsMobile({ className, width, color }) {
  const [isOpen, setIsOpen] = useState(false);

  const toggleExtraSocials = () => setIsOpen(!isOpen)

  return (
    <section className={`socials ${className} ${isOpen ? 'is-open' : ''}`}>
      <div className={`${className}__content`}>
        <a
          href="https://found.ee/thebeths_ig"
          target="_blank"
          rel="noopener noreferrer"
          className={`socials__icon ${className}__icon ${className}__icon--instagram`}
        >
          <Icon name="instagram" width={width} fill={color} />
        </a>
        <a
          href="https://found.ee/thebeths_fb"
          target="_blank"
          rel="noopener noreferrer"
          className={`socials__icon ${className}__icon ${className}__icon--facebook`}
        >
          <Icon name="facebook" width={width} fill={color} />
        </a>
        <a
          href="https://found.ee/thebeths_tw"
          target="_blank"
          rel="noopener noreferrer"
          className={`socials__icon socials__icon--twitter ${className}__icon ${className}__icon--twitter`}
        >
          <Icon name="twitter" width={width} fill={color} />
        </a>
        <a
          href="https://found.ee/thebeths_spotify"
          target="_blank"
          rel="noopener noreferrer"
          className={`socials__icon ${className}__icon ${className}__icon--spotify`}
        >
          <Icon name="spotify" width={width} fill={color} />
        </a>
        <a
          href="https://found.ee/thebeths_yt"
          target="_blank"
          rel="noopener noreferrer"
          className={`socials__icon ${className}__icon ${className}__icon--youtube`}
        >
          <Icon
            name="youtube"
            width={width}
      ...
      <div className={`${className}__content ${className}__extra-socials `}>
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className={`socials__icon socials__icon--apple ${className}__icon ${className}__icon--apple`}
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width={width}
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className={`socials__icon socials__icon--bandcamp ${className}__icon ${className}__icon--bandcamp`}
        >
          <Icon name="bandcamp" width={width} fill={color} />
        </a>
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className={`socials__icon ${className}__icon ${className}__icon--soundcloud`}
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width={width}
